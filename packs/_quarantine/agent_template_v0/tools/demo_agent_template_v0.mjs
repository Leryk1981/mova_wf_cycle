...
const generator = path.join(packDir, "tools", "agent_template_generate_v0.mjs");
const requestPath = path.join(packDir, "docs", "examples", "pos", "agent_template_request_min.json");
