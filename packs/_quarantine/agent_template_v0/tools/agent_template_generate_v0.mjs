...
const schemaPath = path.join(packDir, "ds", "env.agent_template_generate_request_v0.json");
const defaultRequest = path.join(packDir, "docs", "examples", "pos", "agent_template_request_min.json");
