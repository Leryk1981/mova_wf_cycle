...
const generatorScript = path.join(packDir, "tools", "agent_profile_generate_v0.mjs");
const defaultPositiveRequest = path.join(packDir, "docs", "examples", "pos", "agent_profile_request_min.json");
const actionsRequest = path.join(packDir, "docs", "examples", "pos", "agent_profile_request_with_actions.json");
const negativeSuitePath = path.join(packDir, "docs", "agent_profile_negative_suite_v0.json");
const qualityRoot = path.join(repoRoot, "artifacts", "quality", "agent_profile");
const shipScript = path.join(packDir, "tools", "ship_agent_profile_v0.mjs");
