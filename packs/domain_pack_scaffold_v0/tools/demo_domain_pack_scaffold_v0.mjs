...
const generator = path.join(repoRoot, "packs", "domain_pack_scaffold_v0", "tools", "domain_pack_scaffold_generate_v0.mjs");
const requestPath = path.join(repoRoot, "packs", "domain_pack_scaffold_v0", "docs", "examples", "pos", "domain_pack_scaffold_request_min.json");
