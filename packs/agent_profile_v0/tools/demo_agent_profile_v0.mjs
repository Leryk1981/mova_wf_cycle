...
const generator = path.join(repoRoot, "packs", "agent_profile_v0", "tools", "agent_profile_generate_v0.mjs");
const requestPath = path.join(repoRoot, "packs", "agent_profile_v0", "docs", "examples", "pos", "agent_profile_request_min.json");
