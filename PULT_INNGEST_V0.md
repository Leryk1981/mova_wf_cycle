...
Trigger flashslot publish (PowerShell): Invoke-WebRequest -UseBasicParsing -Uri http://localhost:8288/e/dev -Headers @{'Content-Type'='application/json'} -Method POST -Body '{"name":"lab/flashslot.publish","data":{}}'
Trigger flashslot experiment (PowerShell): Invoke-WebRequest -UseBasicParsing -Uri http://localhost:8288/e/dev -Headers @{'Content-Type'='application/json'} -Method POST -Body '{"name":"flashslot.experiment","data":{}}'
