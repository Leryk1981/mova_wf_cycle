# Implementation for `skill.repo_snapshot_basic`

This folder contains the green-layer implementation:

- `prompts/` – prompt profile for LLM-based execution:
  - `repo_snapshot_profile.md` – instructions for the LLM on how to generate repository snapshots

- `bindings/` – runtime binding definitions:
  - `repo_snapshot_llm_binding_v1.json` – LLM profile binding (no external calls)
